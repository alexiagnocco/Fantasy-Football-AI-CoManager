...
Historical documentation and scripts kept for reference. Nothing in this
directory is maintained, and paths/commands inside these files may no longer
match the repository.

| File | What it was | Why archived |
|---|---|---|
| `PHASE4_ADVANCED_INTELLIGENCE.md` | Design/marketing doc for the Phase 4 intelligence system | The system lives in `fantasy-engine/automation/`; the doc predates the current layout |
| `poc-README.md` | `fantasy-engine/README.md` from the POC era | Describes a React client (`client/`) that was removed |
